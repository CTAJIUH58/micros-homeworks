...
Без указания бюджета системы, при прочих равных, больше всего подходит GitLab под все критерии без оговорок.
...
Стек Prometheus + Node Exporter + Grafana даст широкие возможности по кастомизации и отображению мониторинга, а также позволит удобно разместить саму систему мониторинга в инфраструктуре. В качестве менее гибкой альтернативы - zabbix.
