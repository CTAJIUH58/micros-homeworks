...
Многие продукты позволяют реализовать API GateWay и многие выполняют перечисленные требования.

Выбрал бы из представленного NGINX т.к. он: бесплатный, проверенный, легковестный. 
...
RabbitMQ — отвечает требованиям, широко распространён, доступная документация, гибкая настройка.
